...
public:
	...
	int size = earth_.vertices_plane.size();
	std::vector<Point3> start = earth_.vertices_sphere;
	std::vector<Point3> ends = earth_.vertices_plane;
...
private:
	...
	float lon;
	float lat;
	float earthquakeMagnitude[150];
	Point3 earthquakeLocation[150];
